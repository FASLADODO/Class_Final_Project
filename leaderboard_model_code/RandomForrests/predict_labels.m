...
load RandomForrestWithProbabilities.mat;
addpath('ManualFeatureSelection/');
word_counts = manual_feature_reduction(word_counts);
Y_hat = predict(treeModel, full(word_counts));
Y_hat = cellfun(@str2double, Y_hat);
